...
function RegisterForm() {
  ...
  return (
    <div
      className="w-full card o-hidden border-0 shadow-lg "
              ...
              >
                ...
                <div style={{ width: "10rem" }}>
                  {!passwordError.isLenthy ? (
                    <div className="text-danger">Minimo 8 caracteres</div>
                  ) : (
                    ""
                  )}
                  {!passwordError.hasUpper ? (
                    <div className="text-danger">Minimo 1 mayuscula</div>
                  ) : (
                    ""
                  )}
                  {!passwordError.hasLower ? (
                    <div className="text-danger">Minimo 1 minuscula</div>
                  ) : (
                    ""
                  )}
                  {!passwordError.hasNumber ? (
                    <div className="text-danger">Minimo 1 nummero</div>
                  ) : (
                    ""
                  )}
                </div>
