...
export  function  Home() {
	...
	// metodo para salir de firebase con el authentication
	const logOut=async()=>{
		try{
		       ...
		       <SideBar/>
		        ...
		        <div id="content-wrapper" className="d-flex flex-column">
		            ...
		            <div id="content">
		                ...
		                <nav className="navbar navbar-expand navbar-light bg-white  mb-4 static-top shadow">
		                    ...
		                    <form
		                        className="d-none d-sm-inline-block w-50 form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
		                         ...
		                         <Dropdown isOpen={dropdownOpen}  toggle={toggle} >
							        <DropdownToggle 
							        	...
							        	className="
							        		...
							        		border-0
							        		mt-1">
							          {userImg.user.displayName}
		                                <img 
		                                	style={{width:'30px'}}
		                                	className="img-profile rounded-circle mx-2" 
		                                ...
		                                <div className="card-body">
		                                    <div className="text-center">
		                                        <img className="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{width: '25rem'}}
		                                            src="img/undraw_posting_photo.svg" alt="hola cm estas"/>
		                                    </div>
